...
# swap_previous_workspace = "" # optional, unset by default; move active workspace up in sidebar
# swap_next_workspace = ""     # optional, unset by default; move active workspace down in sidebar
