...
pub(super) fn keybind_help_groups(app: &AppState) -> Vec<HelpGroup> {
    ...
    let workspace_tab = vec![
        ...
        help_entry(
            keybind_label(&kb.swap_previous_workspace),
            "swap workspace up",
        ),
        help_entry(
            keybind_label(&kb.swap_next_workspace),
            "swap workspace down",
        ),
    ...
    let panes = vec![
        ...
        help_entry(keybind_label(&kb.widen_sidebar), "widen sidebar"),
        help_entry(keybind_label(&kb.narrow_sidebar), "narrow sidebar"),
